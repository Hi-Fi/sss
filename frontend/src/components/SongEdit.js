			...
			<div>
				...
				<div>
					<Controller
						name="title"
						render={({ field }) => (
							<TextField label="Song Name" variant="standard" {...field} />
						)}
						control={control}
						defaultValue=""
					/>
				...
				<div>
					{fields.map((item, index) => (
						<div key={item.id}>
							...
							<Controller
								...
								control={control}
								render={({ field }) => (
									<TextField variant="standard" {...field} />
								)}
								multiline
								defaultValue=""
							/>
					...
					<button type="button" onClick={() => append({ lyrics: "" })}>
						Add new verse
					</button>
				</div>
				<div>
					<Controller
						name="extraInfo"
						render={({ field }) => (
							<TextField label="Extra Info" variant="standard" {...field} />
						)}
						control={control}
						multiline
						defaultValue=""
				...
				<div>
					<Controller
						name="melody.melody"
						render={({ field }) => (
							<TextField label="Melody" variant="standard" {...field} />
						)}
						control={control}
						defaultValue=""
					/>
				...
				{props.errors && props.errors[props.songId] && (
					<div>
						Error at submit of form. Error message: {props.errors[props.songId]}
					</div>
				)}
			</div>
		</form>
