...
class SongsList extends Component {
	componentDidMount() {
		if (
			!(
				...
				this.props.songsList.songs &&
				this.props.songsList.songs.length > 0
			)
		) {
	...
	render() {
		...
		const emptyRows =
			rowsPerPage - Math.min(rowsPerPage, songs.length - page * rowsPerPage);
			...
			<div className="container">
				...
				<div>
					<Table aria-labelledby="tableTitle">
						...
						/>
						<TableBody>
							{stableSort(songs, getSorting(order, orderBy))
